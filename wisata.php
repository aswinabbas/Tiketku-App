                ...
                <div class="item-big-report col-md-12">
                    ...
                    <table class="table-wisata table-tiketsaya table table-borderless">
                        ...
                        ?>
                            ...
                            <tr>
                                <td><?php echo $checkdata_wisata_final_value['nama_wisata']; ?></td>
                                <td><?php echo $checkdata_wisata_final_value['lokasi']; ?></td>
                                <td><?php echo $checkdata_wisata_final_value['date_wisata']; ?></td>
                                <td>US$ <?php echo $checkdata_wisata_final_value['harga_tiket']; ?></td>
                                <td><a href="manage_wisata.php?nama_wisata=<?php echo $checkdata_wisata_final_value['nama_wisata']; ?>" class="btn btn-small-table btn-primary">Details</a></td>
                            </tr>
